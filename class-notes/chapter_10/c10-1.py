...
for i in range(5):
    ...
    dice2 = dice()
    sum2 = dice1 + dice2
    print(f"{dice1} and {dice2} de kaikei {sum2}")
...
#  Using dictionary instead of if
...
# because is not returning a value, as the function is called, it will print
...
def calc():
    # v = 2  # ローカル変数
    # v = v * 10 (UnboundLocalError: local variable 'v' referenced before assignment) it's trying to make a calculation before it knowns it's value
